...
def fit_e(bin_num = 20, alpha = 2.5, constant = 110000, s = 3):
    ...
    energy_file='C:/Users/tetra/analysis/energy/all_energies.npz'
...
def fit_e2():
    ...
    e_air = []
    u_air = []
    with open('C:/Users/tetra/analysis/energy/air_crosssection.txt') as f:
    ...
    e_bgo = []
    s_bgo = []
    with open('C:/Users/tetra/analysis/energy/bgo_crosssection.txt') as f:
        for line in f.readlines():
