...
def bgo_data(files):
    ...
    bgo = [[], [], []]
    bgo[0] = gmean(pmt0, pmt1)
    bgo[1] = gmean(pmt2, pmt3)
    bgo[2] = gmean(pmt4, pmt5)   
    return bgo


##############################################################################

path0='C:/Users/tetra/array/panama/test/box18/111216_th_1/'
...
plt.show()
if save_plot =='yes':
    plt.savefig(path+'NAME_OF_FILE_TO_SAVE.pdf')
